...
def H_GQint(k,t,i,j,term):
    ...
    for idx1 in arange(max(i,j),min(i,j)+k-1):
        #print idx1
        #print t[idx1-1]
        a = t[idx1]
        b = t[idx1+1]
...
xx = linspace(rmin,rmax,1000) #for plotting
print H_GQint(k,t,2,2,term=2)
...
print H_GQint(k,t,1,1,term=1)
#print H_GQint(k,t,1,1,term=2)
#print H_GQint(k,t,1,1,term=3)
"""
"""
